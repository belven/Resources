...
public class ItemStackFunctions
{
    ...
    private static Class<?> fixBukkitClass(String className)
    {
        className = className.replace("org.bukkit.craftbukkit.",
                "org.bukkit.craftbukkit." + versionPrefix);
        className = className.replace("net.minecraft.server.",
                "net.minecraft.server." + versionPrefix);
        try
        {
    ...
    protected static Object getNMSCopy(ItemStack stack)
    {
        ...
        try
        {
            Method copyMethod = class_CraftItemStack.getMethod("asNMSCopy",
                    ItemStack.class);
    ...
    public static String getMeta(ItemStack stack, String tag)
    {
        ...
        try
        {
            ...
            Method getStringMethod = class_NBTTagCompound.getMethod(
    ...
    public static ItemStack setMeta(ItemStack stack, String tag, String value)
    {
        ...
        try
        {
            Object craft = getNMSCopy(stack);
            Object tagObject = getTag(craft);
            Method setStringMethod = class_NBTTagCompound.getMethod(
                    "setString", String.class, String.class);
            setStringMethod.invoke(tagObject, tag, value);
            Method mirrorMethod = class_CraftItemStack.getMethod(
                    "asCraftMirror", craft.getClass());
    ...
    public static String itemToString(ItemStack is)
    {
        ...
        try
        {
            ...
            {
                Method saveMethod = class_ItemStack.getMethod("save",
            ...
            Method saveMethod = class_NBTBase.getMethod("a", class_NBTBase,
                    DataOutput.class);
    ...
    public static String inventoryToString(final Inventory inventory)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < inventory.getSize(); i++)
            {
                ...
                Method addMethod = class_NBTTagList.getMethod("add",
                        class_NBTBase);
                addMethod.invoke(itemList, outputObject);
            }
    ...
    /*public static ItemStack stringToItemStack(final String data,
            final String name)
    {
        ...
        try
        {
            ...
            final Object itemList = loadMethod.invoke(null,
            ...
            Constructor<?> inventoryConstructor = class_CraftInventoryCustom
                    .getConstructor(InventoryHolder.class, Integer.TYPE,
                            String.class);
            inventory = (Inventory) inventoryConstructor
                    .newInstance(null, listSize,
                            ChatColor.translateAlternateColorCodes('&', name));

            Method setItemMethod = class_CraftInventoryCustom.getMethod(
                    "setItem", Integer.TYPE, ItemStack.class);
            ...
            for (int i = 0; i < listSize; i++)
            {
                ...
                {
                    Method createMethod = class_ItemStack.getMethod(
                            "createStack", inputObject.getClass());
                    Object newStack = createMethod.invoke(null, inputObject);
                    Method bukkitCopyMethod = class_CraftItemStack.getMethod(
                            "asBukkitCopy", class_ItemStack);
                    Object newCraftStack = bukkitCopyMethod.invoke(null,
                            newStack);
